...
# ==> master node un s3 e erismesi icin yetkiyi, ileride s3 ü helm repo olarak ayarlayacagimizdan dolayi verdik
...
resource "aws_instance" "kube-master" {
  ...
  key_name = "clarus"
  subnet_id = "subnet-0ca61c4664ee09d96"  # select own subnet_id of us-east-1a
